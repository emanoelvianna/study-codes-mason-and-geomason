...
public class CampusWorld extends SimState {
  ...
  public CampusWorld(long seed) {
    ...
    try {
      ...
      // this Bag lets us only display certain fields in the Inspector, the
      // non-masked fields
      ...
      URL bldgGeometry = new URL("file:data/bldg.shp");
      ...
      URL roadGeometry = new URL("file:data/roads.shp");
      ...
      URL walkWayGeometry = new URL("file:data/walk_ways.shp");
      ...
      // Now synchronize the MBR for all GeomFields to ensure they cover the
      // same area
  ...
  void addAgents() {
    for (int i = 0; i < numAgents; i++) {
      ...
      // we can set the userData field of any MasonGeometry. If the userData is
      // inspectable,
