...
public class CampBuilder {
   ...
   */
  static void readLineString(LineString geometry, int xcols, int ycols, double xmin, double ymin, double xmax, double ymax, Dadaab dadaab) {
    ...
    while (crawlers.size() > 0) {
      ...
      for (int i = 0; i < size; i++) {
        ...
        if (n == null) { // found something new! Mark it and reproduce
          ...
          dadaab.allCamps.getNeighborsHamiltonianDistance(c.location.getX(), c.location.getY(), 1, false, neighbors, null, null);
